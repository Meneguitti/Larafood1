...
<h1>Planos <a href="{{ route('permissions.create') }}" class="btn btn-success"><i class="fas fa-plus-square"> Novo Plano </i></a></h1>
@stop
                    ...
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td style="width: 250px;">
                                ...
                                <a href="{{ route('permissions.profiles', $permission->id) }}" class="btn btn-info">Vinculados</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
