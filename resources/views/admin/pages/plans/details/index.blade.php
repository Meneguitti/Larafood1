...
<h1>Detalhes do Plano <a href="{{ route('details.plan.create', $plan->url) }}" class="btn btn-success"><i class="fas fa-plus-square"> Adicionar Detalhes </i></a></h1>
@stop
...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-footer pagination pagination-lg">
                @if(isset($filters))
